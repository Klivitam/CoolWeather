...
import com.example.klivitam.coolweather.entry.ForeCast;
import com.example.klivitam.coolweather.entry.Weather;
import com.example.klivitam.coolweather.service.AutoUpdateService;
...
public class WeatherActivity extends AppCompatActivity{
    ...
    public void requestWeather(String weatherId) {
        ...
        Log.i("test", "requestWeather: "+weatherURL);
        HttpUtils.sendOkHttpRequest(weatherURL, new Callback() {
            ...
            public void onResponse(Call call, Response response) throws IOException {
                ...
                Log.i("test", "onResponse: "+weather.basic.cityName);
                runOnUiThread(new Runnable() {
                    @Override
                    public void run() {
                        if(null!=weather && "ok".equals(weather.status)){
                            ...
                            editor.apply();
                            showWeatherInfo(weather);
                            Intent it = new Intent(WeatherActivity.this, AutoUpdateService.class);
                            startService(it);
                        }else{
                            Toast.makeText(WeatherActivity.this,"获取天气信息有误",Toast.LENGTH_LONG).show();
                        }
                        swipeRefresh.setRefreshing(false);
                    }
                });
    ...
    private void showWeatherInfo(Weather weather) {
        ...
        for(ForeCast forecast:weather.foreCastList){
            View view = LayoutInflater.from(this).inflate(R.layout.fore_item,forecastLayout,false);
